...
echo "Export execution remains notebook-driven in THE NOTEBOOK-sanity.ipynb or THE NOTEBOOK-updated.ipynb."
...
echo "Manifest refreshed. Use notebook 91 for any real eval/export execution and write evidence under workspace/runs/<run_id>/."
